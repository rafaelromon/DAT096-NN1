...
#
# Generated by export_simulation on Thu Feb 25 16:49:22 +0100 2021
#
################################################################################
...
'-reset_run' switch to the './config_rom.sh' script.

./config_rom.sh -reset_run
...
./config_rom.sh -noclean_files

For more information on the script, please type './config_rom.sh -help'.
