...
create_clock -period 10.00 -name SYSCLK_N -waveform {5.00 10.00} [get_ports SYSCLK_N]
...
set_property PACKAGE_PIN A19 [get_ports DDR_RST_P]
set_property IOSTANDARD LVCMOS25 [get_ports DDR_RST_P]
set_property PACKAGE_PIN A22 [get_ports init_calib_complete]
...
#set_property PACKAGE_PIN L3 [get_ports DDR3_ADDR[14]]
#set_property IOSTANDARD SSTL15 [get_ports DDR3_ADDR[14]]
#set_property PACKAGE_PIN K2 [get_ports DDR3_ADDR[15]]
...
#set_property PACKAGE_PIN R2 [get_ports DDR3_ODT]
