...
#set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { LED[12] }]; #IO_L16P_T2_CSB_14 Sch=led[12]
...
#set_property -dict { PACKAGE_PIN K17   IOSTANDARD LVCMOS33 } [get_ports { QSPDQ[0] }]; #IO_L1P_T0_D00_MOS14 Sch=qspdq[0]
#set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS33 } [get_ports { QSPDQ[1] }]; #IO_L1N_T0_D01_DIN_14 Sch=qspdq[1]
#set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports { QSPDQ[2] }]; #IO_L2P_T0_D02_14 Sch=qspdq[2]
#set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { QSPDQ[3] }]; #IO_L2N_T0_D03_14 Sch=qspdq[3]
#set_property -dict { PACKAGE_PIN L13   IOSTANDARD LVCMOS33 } [get_ports { QSPCSN }]; #IO_L6P_T0_FCS_B_14 Sch=qspcsn
